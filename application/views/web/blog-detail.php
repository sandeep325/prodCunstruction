                            ...
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="<?php echo base_url('assets/front/images/blog/big-images/4.jpg');?>" alt="blog image">
                                    </a>
                                ...
                                <div class="htc__comment__inner">
                                    ...
                                    <div class="single__comment">
                                        <div class="bl__comment__thumb">
                                            <img src="<?php echo base_url('assets/front/images/comment/1.jpg');?>" alt="comment images">
                                        </div>
                                    ...
                                    <div class="single__comment reply">
                                        <div class="bl__comment__thumb">
                                            <img src="<?php echo base_url('assets/front/images/comment/2.jpg');?>" alt="comment images">
                                        </div>
                                        <div class="bl__comment__details">
                                            <div class="bl__comment__meta">
                                                <h2><a href="#">By Kalvin</a></h2>
                                    ...
                                    <div class="single__comment">
                                        <div class="bl__comment__thumb">
                                            <img src="<?php echo base_url('assets/front/images/comment/3.jpg');?>" alt="comment images">
                                        </div>
                                        <div class="bl__comment__details">
                                            <div class="bl__comment__meta">
                                                <h2><a href="#">By Kalvin</a></h2>
                				...
                				<div class="recent__post__wrap">
	                				<div class="htc__single__post">
	                					<div class="post__thumb">
	                						<a href="blog-details.html"><img src="<?php echo base_url('assets/front/images/blog/sm-img-2/1.jpg');?>" alt="recent post img"></a>
	                					</div>
	                				...
	                				<div class="htc__single__post">
	                					<div class="post__thumb">
	                						<a href="blog-details.html"><img src="<?php echo base_url('assets/front/images/blog/sm-img-2/2.jpg')?>" alt="recent post img"></a>
	                					</div>
	                					<div class="post__details">
	                						<h4><a href="blog-details.html">On the other handeou indiion we produce</a></h4>
	                						<div class="post__meta">
	                				...
	                				<div class="htc__single__post">
	                					<div class="post__thumb">
	                						<a href="blog-details.html"><img src="<?php echo base_url('assets/front/images/blog/sm-img-2/3.jpg');?>" alt="recent post img"></a>
	                					</div>
	                					<div class="post__details">
	                						<h4><a href="blog-details.html">On the other handeou indiion we produce</a></h4>
	                						<div class="post__meta">
                			...
                			<div class="htc__build__dream bg--1 sidebar__separator">
                				<div class="build__dream__inner">
                					...
                					<div class="build__btn">
                						<a class="htc__btn" href="<?php echo base_url('catpage/contact-us');?>">CONTACT US</a>
                					</div>
                				</div>
                			</div>
                			<!-- End Single -->
