...
<?php $this->load->view('web/includes/header') ?>
        ...
        <div class="slider__container">
            <div class="slider__activation__wrap owl-carousel owl-theme">
                <!-- Start Single Slide -->
                <div class="slide slider__fixed--height slide__align--center" style="background: rgba(0, 0, 0, 0) url(<?php echo base_url('assets/front/images/slider/bg/1.jpg');?>) no-repeat scroll 0 0 / cover;" data--black__overlay="6">
                    <div class="container">
                        <div class="row">
                    ...
                    <div class="htc__slider__fornt__img">
                        <img src="<?php echo base_url('assets/front/images/slider/fornt-img/1.png');?>" alt="slider images">
                    </div>
                </div>
                <!-- End Single Slide -->
                <!-- Start Single Slide -->
                <div class="slide slider__fixed--height slide__align--center" style="background: rgba(0, 0, 0, 0) url(<?php echo base_url('assets/front/images/slider/bg/2.jpg');?>) no-repeat scroll 0 0 / cover;" data--black__overlay="6">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <div class="slider__inner">
        ...
        <section class="htc__offer__area htc__offer--2 pb--120 bg__gray">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                        <div class="offer">
                            <div class="offer__icon">
                                <img src="<?php echo base_url('assets/front/images/others/icon-2/1.png');?>" alt="icon images">
                            </div>
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 xmt-40">
                        <div class="offer separator">
                            <div class="offer__icon">
                                <img src="<?php echo base_url('assets/front/images/others/icon-2/2.png');?>" alt="icon images">
                            </div>
                            <div class="offer__details">
                    ...
                    <div class="col-md-4 col-lg-4 hidden-sm col-xs-12 xmt-40">
                        <div class="offer separator">
                            <div class="offer__icon">
                                <img src="<?php echo base_url('assets/front/images/others/icon-2/3.png');?>" alt="icon images">
                            </div>
                            <div class="offer__details">
            ...
            <div class="h1__offer__image">
                <img src="<?php echo base_url('assets/front/images/others/3.png');?>" alt="">
            </div>
        </section>
        <!-- End Offer Area -->
        <!-- Start About Area -->
                        ...
                        <div class="about foo">
                            <div class="about__inner">
                                ...
                                <div class="about__icon">
                                    <img src="<?php echo base_url('assets/front/images/others/icon/1.png');?>" alt="icon images">
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-lg-3 col-sm-6 col-xs-12">
                        <div class="about foo">
                            <div class="about__inner">
                                ...
                                <div class="about__icon">
                                    <img src="<?php echo base_url('assets/front/images/others/icon/2.png');?>" alt="icon images">
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 col-lg-3 hidden-sm col-xs-12">
                        <div class="about foo">
                            <div class="about__inner">
                                ...
                                <div class="about__icon">
                                    <img src="<?php echo base_url('assets/front/images/others/icon/3.png');?>" alt="icon images">
                                </div>
                            </div>
                            <div class="about__inner about__hober__info">
                                <h2><a href="about.html">OUR CERTIFICATE</a></h2>
                    ...
                    <div class="service__section__wrap clearfix">
                        ...
                        <div class="col-md-5 col-lg-4 col-sm-12 col-xs-12">
                            <div class="service__thumb">
                                <img src="<?php echo base_url('assets/front/images/about/2.jpg');?>" alt="about image">
                            </div>
                        </div>
                        <!-- End Single Service -->
                            ...
                            <div class="row">
                                    ...
                                    <div class="service">
                                        <div class="service__thumb">
                                            <a href="single-service.html">
                                                <img src="<?php echo base_url('assets/front/images/service/1.jpg');?>" alt="service images">
                                            </a>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
                                    <div class="service">
                                        <div class="service__thumb">
                                            <a href="single-service.html">
                                                <img src="<?php echo base_url('assets/front/images/service/2.jpg');?>" alt="service images">
                                            </a>
                                            <div class="service__hover">
                                                <div class="service__action">
                                                    <a href="single-service.html">DETAILS</a>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12">
                                    <div class="service">
                                        <div class="service__thumb">
                                            <a href="single-service.html">
                                                <img src="<?php echo base_url('assets/front/images/service/3.jpg');?>" alt="service images">
                                            </a>
                                            <div class="service__hover">
                                                <div class="service__action">
                                                    <a href="single-service.html">DETAILS</a>
                            ...
                            <div class="project__itm foo">
                                <div class="project__thumb">
                                    <a href="single-project.html">
                                        <img src="<?php echo base_url('assests/front/images/lst-project-3/1.jpg');?>" alt="project images">
                                    </a>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="project__itm foo">
                                        <div class="project__thumb">
                                            <a href="single-project.html">
                                                <img src="<?php echo base_url('assets/front/images/lst-project-3/2.jpg');?>" alt="project images">
                                            </a>
                                            <div class="project__hover__info">
                                                <div class="project__action">
                                                    <h2><a href="single-project.html">CONSTRUCTION</a></h2>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="project__itm foo">
                                        <div class="project__thumb">
                                            <a href="single-project.html">
                                                <img src="<?php echo base_url('assets/front/images/lst-project-3/3.jpg');?>" alt="project images">
                                            </a>
                                            <div class="project__hover__info">
                                                <div class="project__action">
                                                    <h2><a href="single-project.html">CONSTRUCTION</a></h2>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="project__itm foo">
                                        <div class="project__thumb">
                                            <a href="single-project.html">
                                                <img src="<?php echo base_url('assets/front/images/lst-project-3/4.jpg');?>" alt="project images">
                                            </a>
                                            <div class="project__hover__info">
                                                <div class="project__action">
                                                    <h2><a href="single-project.html">CONSTRUCTION</a></h2>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="project__itm foo">
                                        <div class="project__thumb">
                                            <a href="single-project.html">
                                                <img src="<?php echo base_url('assets/front/images/lst-project-3/5.jpg');?>" alt="project images">
                                            </a>
                                            <div class="project__hover__info">
                                                <div class="project__action">
                                                    <h2><a href="single-project.html">CONSTRUCTION</a></h2>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="counterup__left__thumb">
                            <img src="<?php echo base_url('assets/front/images/about/4.png');?>" alt="images">
                        </div>
                    </div>
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <div class="htc__callto__action">
                            <h2># OUR <span class="text--theme">ACHIVEMENTS</span></h2>
                            <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble</p>
                            <div class="htc__call__btn">
                                <a class="htc__btn" href="#">BUY NOW</a>
                            </div>
                        </div>
                        <div class="htc__counterup__wrap" style="background: rgba(50, 191, 185, 1) url(<?php echo base_url('assets/front/images/bg/10.png');?>) no-repeat scroll center center / cover ;">
                            <!-- Start Single Fact -->
                            <div class="funfact">
                    ...
                    <div class="htc__team__wrap clearfix mt--30">
                            ...
                            <div class="team foo">
                                <div class="team__inner">
                                    <div class="team__thumb">
                                        <img src="<?php echo base_url('assets/front/images/team/1.jpg');?>" alt="team image">
                                    </div>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
                            <div class="team foo">
                                <div class="team__inner">
                                    <div class="team__thumb">
                                        <img src="<?php echo base_url('assets/front/images/team/2.jpg');?>" alt="team image">
                                    </div>
                                    <div class="team__hover__info">
                                        <ul class="team__social__link">
                                            <li><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12">
                            <div class="team foo">
                                <div class="team__inner">
                                    <div class="team__thumb">
                                        <img src="<?php echo base_url('assets/front/images/team/3.jpg');?>" alt="team image">
                                    </div>
                                    <div class="team__hover__info">
                                        <ul class="team__social__link">
                                            <li><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></li>
                        ...
                        <div class="col-md-3 col-lg-3 hidden-sm col-xs-12">
                            <div class="team foo">
                                <div class="team__inner">
                                    <div class="team__thumb">
                                        <img src="<?php echo base_url('assets/front/images/team/4.jpg');?>" alt="team image">
                                    </div>
                                    <div class="team__hover__info">
                                        <ul class="team__social__link">
                                            <li><a href="#" target="_blank"><i class="fa fa-twitter"></i></a></li>
        ...
        <section class="htc__testimonial__area ptb--130" data--gray__overlay="9.5" style="background: rgba(0, 0, 0, 0) url(<?php echo base_url('assets/front/images/bg/1.jpg');?>) no-repeat fixed center center / cover ;">
            <div class="container">
                <div class="row">
                            ...
                            <div class="testimonial__activation clearfix">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial__thumb">
                                         <img src="<?php echo base_url('assets/front/images/test/client/1.jpg');?>" alt="clint image">
                                    </div>
                    ...
                    <div class="htc__blog__wrap mt--30 clearfix">
                            ...
                            <div class="blog foo">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="<?php echo base_url('assets/front/images/blog/blog-img/1.jpg');?>" alt="blog image">
                                    </a>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                            <div class="blog foo">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="<?php echo base_url('assets/front/images/blog/blog-img/2.jpg');?>" alt="blog image">
                                    </a>
                                    <div class="blog__hover__info">
                                        <ul class="blog__meta">
                                            <li>By : <a href="#">Kalvin</a></li>
                        ...
                        <div class="col-md-4 col-lg-4 hidden-sm col-xs-12">
                            <div class="blog foo">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="<?php echo base_url('assets/front/images/blog/blog-img/3.jpg');?>" alt="blog image">
                                    </a>
                                    <div class="blog__hover__info">
                                        <ul class="blog__meta">
                                            <li>By : <a href="#">Kalvin</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="brand__list">
                            <li><a href="#"><img src="<?php echo base_url('assets/front/images/brand/1.jpg');?>" alt="brand images"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/front/images/brand/2.jpg');?>" alt="brand images"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/front/images/brand/3.jpg');?>" alt="brand images"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/front/images/brand/4.jpg');?>" alt="brand images"></a></li>
                            <li><a href="#"><img src="<?php echo base_url('assets/front/images/brand/5.jpg');?>" alt="brand images"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
