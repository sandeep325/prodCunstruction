...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url();?>assets/back/assets/images/favicon.png">
    <!-- Custom CSS -->
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon ps-2">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url();?>assets/back/assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="<?php echo base_url();?>assets/back/assets/images/logo-text.png" alt="homepage" class="light-logo" />
                    ...
                    <ul class="navbar-nav float-start me-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="d-none d-md-block">Create New Admin <i class="fa fa-angle-down"></i></span>
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="#">subscriber</a></li>
                                <li><hr class="dropdown-divider"></li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<?php echo base_url();?>assets/back/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31">
                            </a>
