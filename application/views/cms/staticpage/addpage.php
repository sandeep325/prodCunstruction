        ...
        <?php $this->load->view('cms/include/sidebar');?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0"><a href="<?php echo base_url().'adminpanel/admin/dashboard';?>">Dashboard </a> / <a href="<?php echo base_url().'adminpanel/staticpage';?>">Manage Pages</a></h5>
                            </div>
                        </div>
